    ...
    >
      ...
      <div className="relative container mx-auto px-6 lg:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* نموذج التواصل */}
          <motion.form
            className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-xl border border-white/10"
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-accent text-accent-foreground font-semibold px-8 py-4 rounded-lg shadow-lg hover:bg-accent-hover transition-transform transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-accent/60"
            >
              إرسال الرسالة
            </button>
          </motion.form>
          ...
          >
            ...
            <div className="bg-white/10 p-6 rounded-2xl shadow-lg border border-white/10 space-y-6">
              {[
                { Icon: Mail, title: "البريد الإلكتروني", value: "support@example.com" },
