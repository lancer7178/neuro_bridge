export default function AboutUs() {
  return (
    <section id="about" className="relative py-20 bg-gradient-to-b from-white to-background-light overflow-hidden">
      {/* زخرفة خلفية */}
      ...
      <div className="container mx-auto px-6 lg:px-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <button className="px-6 py-3 bg-primary text-white rounded-lg shadow-lg hover:bg-primary-hover transition-all">
              تعرف أكثر
            </button>
          </div>
